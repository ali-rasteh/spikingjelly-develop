...
class OneSpikeIFNode(BaseNode):
    ...
    def neuronal_fire(self):
        ...
        self.spike_NL = self.surrogate_function(self.v - self.v_threshold)
        if self.limit:
            self.spike = self.spike_NL * (1.0 - self.fire_mask)
